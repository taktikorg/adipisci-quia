...
[![npm version](https://img.shields.io/npm/v/@taktikorg/adipisci-quia)](https://img.shields.io/npm/v/@taktikorg/adipisci-quia)
...
```bash
npm install @taktikorg/adipisci-quia

# or 

yarn add @taktikorg/adipisci-quia

# or

pnpm add @taktikorg/adipisci-quia
```

Import and use it:

```javascript
import { parseSchema } from '@taktikorg/adipisci-quia';
